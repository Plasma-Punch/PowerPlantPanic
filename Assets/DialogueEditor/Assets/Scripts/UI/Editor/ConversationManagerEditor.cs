...
namespace DialogueEditor
{
    ...
    public class ConversationManagerEditor : Editor
    {
        ...
        SerializedProperty FreezePlayerProperety;
        ...
        private void OnEnable()
        {
            ...
            FreezePlayerProperety = serializedObject.FindProperty("ChangeCanMove");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Label("Freeze Player Event", EditorStyles.boldLabel);
            EditorGUILayout.PropertyField(FreezePlayerProperety);
